...
const POETIC_LINES = [
  ...
  'شما موفق شدین مراحل سخت زندگی به پایان برسونید',
  'به همین راحتی بعد از گذروندن مراحل سخت زندگیتون شما بهم رسیدین',
  'امیدوارم که همیشه همینجوری مراحل رد کنین',
  'از طرف حسن میگم دوست دارم دخترم',
  'ساخته شده تماما توسط حسن',
            ...
            {showFinalTitle && (
              ...
              >
                ...
                <p className="text-xs sm:text-sm text-slate-300 max-w-md leading-relaxed mt-2">
                  تقدیم با عشق بی‌پایان به دخترم نیوشا • ساخته شده تماماً توسط حسن
                </p>
              </motion.div>
            )}
          </AnimatePresence>
